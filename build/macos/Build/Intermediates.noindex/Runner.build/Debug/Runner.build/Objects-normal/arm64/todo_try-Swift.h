...
#ifndef TODO_TRY_SWIFT_H
#define TODO_TRY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="todo_try",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8todo_try11AppDelegate")
...
SWIFT_CLASS("_TtC8todo_try17MainFlutterWindow")
